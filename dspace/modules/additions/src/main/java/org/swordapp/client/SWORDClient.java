...
public class SWORDClient
{
    ...
    protected URL formaliseURL(String url)
            throws SWORDClientException
    {
        try
        {
    ...
    protected void prepAuth(AuthCredentials auth, AbderaClient client, RequestOptions options)
            throws SWORDClientException
    {
    ...
    protected void logDepositRequest(AuthCredentials auth, String url, Deposit deposit, String operation)
    {
        // log the request
