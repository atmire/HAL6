package com.atmire.compliance.hal.submission;
 ...
 * Time: 11:02
 */
public class HALComplianceStep extends AbstractProcessingStep {

    public static final int STATUS_BLOCKED = 2;

    private static final String blockSubmissionConfig = "hal.submission.block.on.rule.violation.";
    ...
    private static ComplianceCheckService complianceCheckService = new DSpace().getServiceManager()
            .getServiceByName("halComplianceCheckService", ComplianceCheckService.class);
