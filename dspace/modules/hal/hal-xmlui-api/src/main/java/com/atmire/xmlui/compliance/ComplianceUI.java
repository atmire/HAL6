...
import com.atmire.compliance.result.CategoryComplianceResult;
...
public class ComplianceUI {
    ...
    public void addComplianceSections(Division div, org.dspace.content.Item item, org.dspace.core.Context context) throws WingException, SQLException {
    ...
    private void addCategorySections(Division div, ComplianceResult result) throws WingException {
        ...
        for (CategoryComplianceResult categoryComplianceResult : result.getOrderedCategoryResults()) {
            ...
            para.addContent(categoryComplianceResult.getCategoryName());
