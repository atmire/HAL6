...
public class MetadataValue implements ReloadableEntity<Integer>
{
    ...
    /** The child metadata values that are related to this MetadataValue */
    @OneToMany(fetch = FetchType.LAZY, mappedBy= "parentMetadataValue")
    private List<MetadataValue> childMetadataValues = new ArrayList<>();

    /** The parent metadata value that is related to this MetadataValue */
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "parentMetadataValue")
    private MetadataValue parentMetadataValue = null;
    ...
    public List<MetadataValue> getChildMetadataValues(){
        Hibernate.initialize(this);
        return childMetadataValues;
    }


    public void addMetadataValue(MetadataValue metadataValue) {
        childMetadataValues.add(metadataValue);
    }

    public void removeMetadataValue(MetadataValue metadataValue) {
        childMetadataValues.remove(metadataValue);
    }

    public MetadataValue getParentMetadataValue(){
        return parentMetadataValue;
    }

    public void setParentMetadataValue(MetadataValue metadataValue) {
        this.parentMetadataValue = metadataValue;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        if(this.getChildMetadataValues() != other.getChildMetadataValues()){
            return false;
        }
        if(this.getParentMetadataValue() != other.getParentMetadataValue()){
            return false;
        }
    ...
    public boolean equalsIgnoreRelations(Object obj)
    {
        if (obj == null)
        {
            return false;
